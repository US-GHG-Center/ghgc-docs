...
2. Dataset **usage** examples, e.g. for the [Wetland Methane Emissions from the LPJ-EOSIM model](user_data_notebooks/lpjeosim-wetlandch4-daygrid-v2_User_Notebook.ipynb) dataset, that shows how to load the dataset in Python in [JupyterHub](services/jupyterhub.qmd).
