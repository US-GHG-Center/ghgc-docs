...
3. Dataset **transformation** scripts, which document the code used to transform datasets for display in the US GHG Center. An example is the [ODIAC Fossil Fuel CO₂ Emissions](cog_transformation/odiac-ffco2-monthgrid-v2022.ipynb) dataset transformation code.
