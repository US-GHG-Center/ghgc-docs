# CASA-GFED3 Land Carbon Flux - Data Transformation Code

Code used to transform CASA-GFED3 Land Carbon Flux data from netcdf to Cloud Optimized Geotiff.

Python file can be downloaded <a href="./scripts/casagfed-carbonflux-monthgrid-v3_Transformation_Code.py" download="casagfed-carbonflux-monthgrid-v3_Transformation_Code.py">here</a>.
