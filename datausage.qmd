...
3. Carbon Dioxide and Methane Concentrations from the Indianapolis Flux Experiment (INFLUX)
   - [Beginner level notebook](user_data_notebooks/influx-testbed-ghg-concentrations_User_Notebook.ipynb) to access, visualize, explore statistics, and create a time series of the Atmospheric concentrations of carbon dioxide (CO₂) and methane (CH₄) collected at NIST Urban Test Bed tower.
4. Carbon Dioxide and Methane Concentrations from the Los Angeles Megacity Carbon Project
   - [Beginner level notebook](user_data_notebooks/lam-testbed-ghg-concentrations_User_Notebook.ipynb) to access, visualize, explore statistics, and create a time series of the Atmospheric concentrations of carbon dioxide (CO₂) and methane (CH₄) collected at NIST Urban Test Bed tower.
lam-testbed-ghg-concentrations_User_Notebook.ipynb
5. Carbon Dioxide and Methane Concentrations from the Northeast Corridor (NEC) Urban Test Bed
   - [Beginner level notebook](user_data_notebooks/nec-testbed-ghg-concentrations_User_Notebook.ipynb) to access, visualize, explore statistics, and create a time series of the Atmospheric concentrations of carbon dioxide (CO₂) and methane (CH₄) collected at NIST Urban Test Bed tower.
